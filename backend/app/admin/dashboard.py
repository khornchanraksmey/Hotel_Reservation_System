...
from app.services.report_service import get_dashboard_stats, get_revenue_chart, get_bookings_by_type
...
async def revenue_chart(days: int = Query(30, ge=7, le=365), db: AsyncSession = Depends(get_db), _: User = Depends(get_current_admin)):
